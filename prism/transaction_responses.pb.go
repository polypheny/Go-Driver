...
var file_org_polypheny_prism_transaction_responses_proto_goTypes = []any{
...
func file_org_polypheny_prism_transaction_responses_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_org_polypheny_prism_transaction_responses_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_org_polypheny_prism_transaction_responses_proto_msgTypes[1].Exporter = func(v any, i int) any {
